...
class Users extends Front_Controller
{
	...
	public function reset_password($email='', $code='')
	{
		...
		if ($this->auth->is_logged_in() === FALSE)
		{
			...
			if ($this->input->post('submit'))
			{
				$this->form_validation->set_rules('password', 'lang:bf_password', 'required|trim|strip_tags|max_length[120]|valid_password');
	...
	private function save_user($id=0, $meta_fields=array())
	{
		...
		$this->form_validation->set_rules('password', 'lang:bf_password', 'trim|strip_tags|max_length[120]|valid_password');
